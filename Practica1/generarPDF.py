...
so = str(consultaSNMP('ricardovargassagrero', '10.100.70.14', '1.3.6.1.2.1.1.1.0'))
ubi = str(consultaSNMP('ricardovargassagrero', '10.100.70.14', '1.3.6.1.2.1.1.6.0'))
numPuertos = str(consultaSNMP('ricardovargassagrero', '10.100.70.14', '1.3.6.1.2.1.2.1.0'))
tiempoActivo = str(consultaSNMP('ricardovargassagrero', '10.100.70.14', '1.3.6.6.1.2.1.1.3.0'))
...
pdf.image("windows.png", x = 150, y = 35, w = 35, h = 25)
